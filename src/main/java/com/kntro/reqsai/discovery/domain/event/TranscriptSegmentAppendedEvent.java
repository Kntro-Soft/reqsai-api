 ...
 * @param projectId   owning a project (for cross-module routing, e.g. Billing)
...
public record TranscriptSegmentAppendedEvent(
    ...
    public static TranscriptSegmentAppendedEvent of(UUID sessionId, UUID projectId, int sequence, @Nullable String speakerLabel, String text, long startMs, long endMs, boolean isFinal) {
        return new TranscriptSegmentAppendedEvent(sessionId, projectId, sequence, speakerLabel, text, startMs, endMs, isFinal, Instant.now());
    }
