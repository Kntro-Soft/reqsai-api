...
@Schema(description = "Request body to add an acceptance criterion to a user story")
public record AddAcceptanceCriterionRequest(

        @Schema(description = "Optional scenario label, e.g. 'Scenario: happy path'. Max 200 chars.",
